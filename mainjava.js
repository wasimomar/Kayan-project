...
const translations = {
  ar: {
    ...
    hero_subheadline:  'كيان للتطوير العقاري – شريكك الموثوق في بناء أفضل مشاريع السكن والاستثمار في مصر',
    ...
    footer_copy:          '© 2025 كيان للتطوير العقاري. جميع الحقوق محفوظة.',
  ...
  en: {
    ...
    hero_subheadline:  'Kayan Real Estate Development – Your trusted partner for the finest residential and investment projects in Egypt',
    ...
    footer_copy:          '© 2025 Kayan Real Estate Development. All Rights Reserved.',
...
function buildModalContent(projectKey) {
  ...
  if (cta) {
    ...
    if (ctaSpan) ctaSpan.textContent = t['modal_cta'];
    else cta.textContent = t['modal_cta'];
  }
